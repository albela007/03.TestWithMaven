...
public class ManagementEmployeeTest {
	...
	// Negative scenario
	/*
	 * @Test public void testHourlyWageNegative() { ManagementEmployee m = new
	 * ManagementEmployee(52000,40); float wage = m.getHourlyWage();
	 * 
	 * //assertTrue(wage ==252); assertTrue("Salary: " + wage, wage == 252); }
	 */
